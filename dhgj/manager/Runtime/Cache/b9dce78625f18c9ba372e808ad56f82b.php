...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td>
            <img class="preview" src="<?php echo ($news['s_pic_urls']); ?>">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="is_cream" value="0" <?php if($news['is_cream'] == 0): ?>checked="checked"<?php endif; ?> />否
            <input type="radio" name="is_cream" value="1" <?php if($news['is_cream'] == 1): ?>checked="checked"<?php endif; ?> />是
        </td>
    </tr>
    <tr>
        <td class="tableleft">内容</td>
        <td><textarea name="conten" id="content" style="width:845px;"><?php echo ($news['content']); ?></textarea></td>
    </tr>
    <tr>
...
<script language="javascript">
    ...
    $(function(){
        ...
        $('button.btn-primary').click(function(){
           ...
           $.ajax({  
              url: "<?php echo U('/Media/sub_edit_news');?>",  
              type: 'POST',  
              data: formData,  
              async: false,  
              cache: false,  
