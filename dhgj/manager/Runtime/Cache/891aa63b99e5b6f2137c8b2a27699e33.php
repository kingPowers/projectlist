...
<div><span>GPS信息</span></div>
<div id="content">
<form>
	<table class="table table-bordered table-hover definewidth m10">
		<tr>
			<td valign="middle" align="center">GPS账号</td>
            <td class="value" align="center" valign="middle"><?php echo ($info['GPS_member']); ?></td>
		</tr>
		<tr>
			<td valign="middle" align="center">GPS密码</td>
            <td class="value" align="center" valign="middle"><?php echo ($info['GPS_password']); ?></td>
		</tr>
		<tr>
			<td valign="middle" align="center">平台地址</td>
            <td class="value" align="center" valign="middle"><?php echo ($info['GPS_url']); ?></td>
		</tr>
	</table>
</form>
</div>
