...
<body>
<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width: 400px;float: left;">
<p>姓名：<span style="color: red;"><?php echo ($vo['names']); ?></span></p>
<p>性别：<span style="color: red;"><?php if(($vo['sex']) == "0"): ?>男<?php else: ?>女<?php endif; ?></span></p>
<p>身份证：<span style="color: red;"><?php echo ($vo['certiNumber']); ?></span></p>
<p>贷款城市：<span style="color: red;"><?php echo ($vo['loan_city']); ?></span></p>
<p>贷款公司：<span style="color: red;"><?php echo ($vo['loan_company']); ?></span></p>
<p>贷款金额：<span style="color: red;"><?php echo ($vo['loan_money']); ?></span></p>
<p>抵押公司：<span style="color: red;"><?php echo ($vo['mort_company']); ?></span></p>
<p>已还期数：<span style="color: red;"><?php echo ($vo['return_num']); ?></span></p>
<p>车辆型号：<span style="color: red;"><?php echo ($vo['car_brand']); ?></span></p>
<p>车牌号码：<span style="color: red;"><?php echo ($vo['plate_num']); ?></span></p>
<p>车架号码：<span style="color: red;"><?php echo ($vo['frame_num']); ?></span></p>
<p>GPS账号：<span style="color: red;"><?php echo ($vo['GPS_member']); ?></span></p>
<p>GPS密码：<span style="color: red;"><?php echo ($vo['GPS_password']); ?></span></p>
<p>GPS地址：<span style="color: red;"><?php echo ($vo['GPS_url']); ?></span></p>
<p>拖车价格：<span style="color: red;"><?php echo ($vo['trail_price']); ?></span></p>
</div>
<?php if(!empty($vo['pic_url'])): ?><div style="float: left;">
<p><b>客户照片：</b><?php if(is_array($vo['pic_url']['user_pic'])): foreach($vo['pic_url']['user_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>身份证照片：</b><?php if(is_array($vo['pic_url']['certi_pic'])): foreach($vo['pic_url']['certi_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>贷款合同：</b><?php if(is_array($vo['pic_url']['loanContract_pic'])): foreach($vo['pic_url']['loanContract_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>抵押合同：</b><?php if(is_array($vo['pic_url']['mortContract_pic'])): foreach($vo['pic_url']['mortContract_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>行驶证：</b><?php if(is_array($vo['pic_url']['travelLicense_pic'])): foreach($vo['pic_url']['travelLicense_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>驾驶证：</b><?php if(is_array($vo['pic_url']['driveLicense_pic'])): foreach($vo['pic_url']['driveLicense_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p><hr/>
<p><b>车辆登记证：</b><?php if(is_array($vo['pic_url']['carRegistration_pic'])): foreach($vo['pic_url']['carRegistration_pic'] as $key=>$v): ?><img src="<?php echo ($v); ?>"><?php endforeach; endif; ?></p>
