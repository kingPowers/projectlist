...
<div class="content">
	<div class="center_div">
		...
		<div class="w1200 bgf">
			...
			<?php if(is_array($news_list)): foreach($news_list as $key=>$vo): ?><div class="media_one">
				<div class="media_img"><img src="<?php echo ($vo['pic_urls'][0]); ?>" onclick="javascript:window.location.href='/media/news/id/<?php echo ($vo["id"]); ?>'"></div>
				<div class="w615">
					<div class="tit_blue"><?php echo ($vo['title']); ?></div>
					<div class="data_blue"><?php echo ($vo['lasttime']); ?></div>
					<div class="h135"><?php echo ($vo['intro']); ?>
					<a onclick="javascript:window.location.href='/media/news/id/<?php echo ($vo["id"]); ?>'">【详情】</a> 
					</div>
				</div>				
    ...
    <div class="center">
        <div class="footer_t">
            <ul class="c_fot_ul c_left">
                <li>
                    <h3 onclick="window.location.href='/order/neworderlist'">最新订单</h3> 
                    <h3 onclick="window.location.href='/company/index'">公司介绍</h3>                    
                </li>
                <li>
                    <h3 onclick="window.location.href='/order/neworderlist'">历史订单</h3> 
                    <h3 onclick="window.location.href='/media/index'">媒体公告</h3>                    
                </li> 
            </ul>
