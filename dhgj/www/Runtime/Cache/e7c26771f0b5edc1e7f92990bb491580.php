...
<div class="content">
	<div class="center_div">
		...
		<div class="w1200 bgf">
			...
			<h2 class="mcon_tit"><?php echo ($info['title']); ?></h2>
			<div class="dbd_media">发布时间：<?php echo ($info['lasttime']); ?> <font>浏览次数：<?php echo ($info['scan']); ?></font></div>
			<?php if(!empty($info['pic_urls'][0])): ?><div class="img_div" style="width:600px;margin:20px auto;text-align: center;"><img style="max-height: 200px; width: auto;" style="" src="<?php echo ($info['pic_urls'][0]); ?>"></div><?php endif; ?>	
			<div class="dbd_con"><?php echo ($info['content']); ?></div>
			<div class="dbd_ud">
			    <?php if(empty($info['preNews'])): ?><a >上一篇：没有了 </a>
			     <?php else: ?>
			     <a href="/media/news/id/<?php echo ($info['preNews']['id']); ?>">上一篇：<?php echo ($info['preNews']['title']); ?> </a><?php endif; ?>
				<?php if(empty($info['nextNews'])): ?><a>下一篇：没有了 </a>
			     <?php else: ?>
			     <a href="/media/news/id/<?php echo ($info['nextNews']['id']); ?>">下一篇：<?php echo ($info['nextNews']['title']); ?> </a><?php endif; ?>
			</div>
		</div> 
	</div>
</div>
