...
<link rel="stylesheet" href="_STATIC_/2015/member/css/tender.css">
    <div class="rec_t">
        <ul class="ba_min_nav">
            ...
            <li><a href="/member/tender_inter">计息中</a></li>
            <li class="now"><a href="/member/tender_yes">已到期</a></li>
        </ul>
    </div>
    ...
    <div class="tender_div">
        <table class="tender_table">
            ...
            <tr>
                ...
                <td>102700</td>
                <td>2015-05-09</td>
                <td><a href="javascript:;" class="tender_detail">还款明细</a> | <a href="">协议</a></td>
            </tr>
        </table>
    </div>
