...
class IndexAction extends CommonAction {
	...
	private $_client_keys_ = array('WEB'=>'123456','IOS'=>'123456','ANDROID'=>'123456','BROWSER'=>'123456','SMS'=>'SMSAPI201408');
	public $_deviceid_;
	public $_client_;
	public $_sign_;
	public $_token_;
	...
	public function service_error($code,$message,$data=''){
		...
		exit(json_encode($this->other2String(array('errorcode'=>$code,'errormsg'=>$message,'dataresult'=>$data,'servertime'=>time()),$this->_client_)));
	}

	public function service_success($data=''){
		$this->logger->w("Success---".serialize($data));
		header("Content-type: application/json");
		exit(json_encode(array('errorcode'=>0,'errormsg'=>'','dataresult'=>$this->other2String($data,$this->_client_),'servertime'=>time())));
	}
