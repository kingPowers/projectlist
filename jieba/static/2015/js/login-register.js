//注册、登录
(function($) {
	var loginUrl = '/member/doLogin.html',
		registerUrl = '/member/doRegister.html',
		//uniqueUrl = '/member/checkUnique.html',
	...
	var _repassword = function(val, n) {
			if ($(n).attr('rel') == val || val == '') {
				_error(val, n);
				return false;
			}
    ...
    var _verifycode = function(val, n) {
