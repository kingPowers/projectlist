(function(e, t) {
	...
	return k.prototype = {
		...
		adjustPosition: function() {
			...
			a + n > s && (a = a - n + e.offsetWidth), f + i > o + u && (f = f - i - e.offsetHeight), this.el.style.cssText = "position:absolute;left:" + 58 + "px;top:" + f + "px;"
		},
		render: function(e, t) {
			var n = this._o,
				r = new Date,
		...
		show: function() {
			...
			document.getElementsByClassName("datepickerDiv")[0].style.display = "block";
		},
		hide: function() {
			var e = this._v;
			...
			document.getElementsByClassName("datepickerDiv")[0].style.display = "none";
		},
		destroy: function() {
