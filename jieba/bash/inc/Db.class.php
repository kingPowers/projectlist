...
class MyPDO {
    ...
    public function __construct($dsn, $username, $passwd, $options = null) {
        ...
        if ($this->logger->isInfoEnabled()) {
            ...
            $this->logger->info("Connect DB:{$dsn[1]}");
        }
    }
    ...
    public function __destruct() {
        ...
        if ($this->logger->isInfoEnabled()) {
            $dsn = explode(';', $this->dsn);
            $this->logger->info("[{$dsn[1]}] Query Count: {$this->queryCount}");
        }
    }
     ...
     */
    public function query($statement,$log = true) {
        if ($this->logger->isDebugEnabled() && $log) {
