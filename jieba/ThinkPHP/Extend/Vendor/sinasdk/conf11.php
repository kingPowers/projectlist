 ...
 * 商户号，由新浪支付提供
 */
define("sinapay_partner_id","200015365658");//裸接口商户号
/**
 * 商户MD5KEY秘钥，由商户提供
 */
define("sinapay_md5_key", "123456789101112");//MD5KEY 123456789101112
/**
 * 商户接口字符集，新浪支付接口文档参数
 */
 ...
 * 商户签名私钥，由商户自己生成
 */
define("sinapay_rsa_sign_private_key",dirname(__File__) ."/key/200015365658_sign_pub.pem");//签名私钥
/**
 * 商户验证签名公钥，由新浪提供
 */
 ...
 */
define("sinapay_rsa_public__key",dirname ( __File__ )."/key/200015365658_encrypt_pub.pem");//加密公钥
/**
 * 网关地址，接口文档参数
 */
