        ...
        <div class="maxDiv">
            ...
            <div class="centerDiv">
                <form action="login" method="post" name="weixin_login">
                    ...
                    <input value="<?php if(!empty($_POST['mobile'])): echo ($_POST['mobile']); else: ?>请输入手机号码<?php endif; ?>" placeholder="请输入手机号码" onfocus="if (value == '请输入手机号码') {
                                value = ''
                            }" onblur="if (value == '') {
                                        value = '请输入手机号码'
...
<!--                    <img src="_STATIC_/2015/member/image/login/line1.png" class="lineImg"/>-->
                    ...
                    <div class="linexImg" style='color:red;padding-top:15px;'><?php echo ($error); ?></div>
