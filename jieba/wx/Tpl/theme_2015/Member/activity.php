...
<head>
    ...
    <script type="text/javascript"> 
       ...
       <style type="text/css">
        ...
        .bg_t{background: url(_STATIC_/2015/activity/image/activity41/bg_20.png); background-size:100% 100%; width: 100%; color: #fff; font-size: 12px;}
        .bg_f{background: url(_STATIC_/2015/activity/image/activity41/bg_41.png); background-size:100% 100%; width: 100%; color: #fff; font-size: 12px;}
        @media (min-width: 320px){.piao_table_t{height: 160px;} .piao_con{width: 70%; position: absolute; padding: 27% 0 0 18%;} }
        ...
        .about_quan{ width: 90%; position: absolute; left: 50%; margin:50% 0 0 -45%; text-align: center; font-size: 14px;}
    </style>
</head>
...
<section class="content">
    <section class="page_con">
        <ul class="ck_header">
            <li class="liStyle blue_css">今日礼券</li>
            <li class="liStyle" onclick="javascript:window.location.href='/member/activity_overdue'">已过期礼券</li>
        </ul>
    </section>
    <empty name="ticket_lists">
    <section class="about_quan">
      暂无活动券！点击 <a href="/member/activity_share">邀请好友</a>  
    </section>
    </empty>
    <foreach name="ticket_lists" item="vo">
