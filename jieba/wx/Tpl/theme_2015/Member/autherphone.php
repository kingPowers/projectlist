...
<div class="maxDiv"><!--大盒子-->
    ...
    <div class="centerDiv"><!--中-->
        <div class="center1">
            <input type="checkbox" name="checkbox" class="checkbox" id="checkbox"  value="1" checked="checked" disabled="true">
            <span class="phone">已认证 </span>
        </div>
        <div class="center2">
...
<div class="thirdDiv">
    <p class="notice tsize">在线客服</p>
    <p class="notice2 tsize">客服电话：400 663 9066</p>
