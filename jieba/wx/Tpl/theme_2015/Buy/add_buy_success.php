...
<html>
    <head>
        ...
        <link rel="stylesheet" href="_STATIC_/2015/buy/css/add_buy_success.css" />
...
<!--            <span class="zxwx sizeOne">提交成功</span>-->
        ...
        <div class="contentDiv">
            ...
            <div class="oneDiv">
                ...
                <div class="rightwords threesize">{$order.dealer}</div>
            </div>
            <div style="width:97%;border-top:1px solid #efefef;margin-left:3%;"></div>
            <div class="oneDiv">
                <div class="leftwords threesize">
            ...
            <div class="oneDiv">
                ...
                <div class="rightwords threesize">{$order.car_brand}</div>
            </div>
            <div style="width:97%;border-top:1px solid #efefef;margin-left:3%;"></div>
            <div class="oneDiv">
                <div class="leftwords threesize">
                ...
                <div class="rightwords threesize">{$order.car_class}</div>
            </div>
            <div style="width:97%;border-top:1px solid #efefef;margin-left:3%;"></div>
            ...
            <div class="oneDiv">
             ...
             <div class="oneDiv">
                ...
                <div class="rightwords threesize"><span class="colornum foursize">{$order.first_money}</span>元</div>
            </div>
